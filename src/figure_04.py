...
fslab=10
fstlab=8
fig = plt.figure(figsize=(4 ,7), dpi=1000,facecolor='w')
...
ti = ax1.set_title('(a) Surface velocity modulus climatology',fontsize=10, ha='left', x=-.25)
ax1.set_xticks([-80., -78., -76., -74., -72., -70.])
ax1.tick_params(labelbottom=False)    
ax1.tick_params(labelsize=fstlab)
ax1.set_xlim([-82., -70.])
ax1.set_ylim([22,32])
...
cb.set_label('Velocity (m/s)',fontsize=fslab)
cb.ax.tick_params(labelsize=fstlab)
#
#
ax2 = plt.subplot(412)
plt.pcolor(lon,depth,climsec,cmap=cmapmean,vmin=-0.5,vmax=+0.5)
ti = ax2.set_title('(b) Meridional velocity climatology at 28N',fontsize=10, ha='left', x=-.25)
ax2.set_xlim([-82., -70.])
ax2.invert_yaxis()
ax2.set_xticks([-80., -78., -76., -74., -72., -70.])
ax2.tick_params(labelbottom=False)    
ax2.tick_params(labelsize=fstlab)
...
ti = ax3.set_title('(c) Anomalies for high BTR values',fontsize=10, ha='left', x=-.25)
ax3.set_xlim([-82., -70.])
ax3.invert_yaxis()
ax3.set_xticks([-80., -78., -76., -74., -72., -70.])
ax3.tick_params(labelbottom=False)    
ax3.tick_params(labelsize=fstlab)
...
ti = ax4.set_title('(d) Anomalies for high GEOSH values',fontsize=10, ha='left', x=-.25)
ax4.set_xlim([-82., -70.])
ax4.invert_yaxis()
ax4.set_xticks([-80., -78., -76., -74., -72., -70.])
ax4.tick_params(labelsize=fstlab)
