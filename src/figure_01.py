...
fileclimBTR    = '../data/ORCA0083-N06_timemean_19602012_BTRvalor_d05.nc'
fileclimEKM    = '../data/ORCA0083-N06_timemean_19602012_EKMvalor_d05.nc'
fileclimRES    = '../data/ORCA0083-N06_timemean_19602012_RESvalor_d05.nc'
fileclimGEO    = '../data/ORCA0083-N06_timemean_19602012_GEOvalor_d05.nc'
fileclimGEOBTR = '../data/ORCA0083-N06_timemean_19602012_GEOBTRvalor_d05.nc'
#===========================================================================
...
#
ax1 = plt.subplot(511)
plt.pcolor(lat,depth,climmean,cmap=shifted_cmap,vmin=-5,vmax=20)
...
# ============
ax2 = plt.subplot(512)
plt.pcolor(latBTR,depth,tabclimEKM,cmap=cmapmean,vmin=-30,vmax=+30)
plt.axvline(x=26,ymin=0,ymax=6000,color='red',linewidth=1.3)
...
# ============
ax3 = plt.subplot(513)
plt.pcolor(latBTR,depth,tabclimBTR,cmap=cmapmean,vmin=-30,vmax=+30)
plt.axvline(x=26,ymin=0,ymax=6000,color='red',linewidth=1.3)
...
# ============
ax4 = plt.subplot(514)
plt.pcolor(latBTR,depth,tabclimGEO,cmap=cmapmean,vmin=-30,vmax=+30)
plt.axvline(x=26,ymin=0,ymax=6000,color='red',linewidth=1.3)
...
cax4 = divider.append_axes("right", size="5%", pad=0.4)
...
# =============
ax5 = plt.subplot(515)
plt.pcolor(latBTR,depth,tabclimRES,cmap=cmapmean,vmin=-30,vmax=+30)
plt.axvline(x=26,ymin=0,ymax=6000,color='red',linewidth=1.3)
