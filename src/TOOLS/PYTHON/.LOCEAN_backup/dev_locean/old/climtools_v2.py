# -*-coding:Latin-1-*
# =========================================================================
# Packages de fonctions utiles à l'analyse de données climatiques
#
# -------------------
# Author : A. Germe
# 7 May 2014
# Version 2
# -------------------
# L'ajout d'une option max et min à la fonction regional average posait un 
# problème avec le module MA dont je me servais jusqu'à présent pour les
# masked_array. Il était impossible d'avoir un max ou min suivant un axe 
# précis.
# je suis donc passée au sous module numpy.ma dans la version suivante qui
# semble équivalent, mais avec méthode max et min en plus. 
# De plus le module numpy.ma semble beaucoup plus utilisé que MA lorsque l'on
# regarde sur internet. Il est donc préférable de se servir de ce module
# pour une transportabilité de climtools pour facile.
# Attention !!!! Tous les diags avant le 7 mai 2014 ont été calculé avec la 
# la version 2 de climtools. 
# Dans cette version, l'option max et min de regional_average est ecrite,
