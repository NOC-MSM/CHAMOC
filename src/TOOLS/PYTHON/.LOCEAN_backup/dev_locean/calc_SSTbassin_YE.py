...
for year in range(yrdeb,yrfin+1) :
  ...
  #
  tab_glo_yr = MA.average(tab_glo,axis=0)
  tab_atl_yr = MA.average(tab_atl,axis=0)
  tab_pac_yr = MA.average(tab_pac,axis=0)
  ...
  if sstglo.shape[0]==0 :
    ...
    i1=len(sstglo)
    sstglo[i1]=tab_glo_yr
    sstatl[i1]=tab_atl_yr
    sstpac[i1]=tab_pac_yr
    times[i1]=timex.num()
  del tab_glo, tab_atl, tab_pac, tab_glo_yr, tab_atl_yr, tab_pac_yr
#
