...
if os.path.exists(fileout) :
  ...
  dwf.units = 'm3'
  dwf.long_name = '%s deep water formation index computed as the volume of the convection patch = somxl010 * cell area. Only area celles where somxl010 > 400is considered in the sum.'%domain
  #
#
#
#
