...
#======================================================================== 
# utilisation :
#        cdat calc_timemean_3D_MO.py EXP_ID zomstfatl (yrstart yrend)
# Exemple :
#        cdat calc_timemean_3D_MO.py N006
#        cdat calc_timemean_3D_MO.py N006 zomstfalt 1960 1965
# =======================================================================
EXP_ID  = sys.argv[1]
varname = sys.argv[2]
exp = dexp[EXP_ID]
